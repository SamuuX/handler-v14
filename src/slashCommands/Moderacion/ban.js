...
module.exports = {
    ...
    .addUserOption(option => option.setName('usuario').setDescription('Menciona el usuario').setRequired(true))
    .addStringOption(option => option.setName('razon').setDescription('Menciona la razón').setRequired(false)),
